...
VideoReceiver::start()
{
    ...
    do {
        ...
        // Run audio
        GError *error = NULL;
        GstElement* audiopipeline = gst_parse_launch("udpsrc port=5601 ! application/x-rtp, media=audio, clock-rate=44100, encoding-name=L16, encoding-params=1, channels=1, payload=96 ! rtpL16depay ! autoaudiosink", &error);
